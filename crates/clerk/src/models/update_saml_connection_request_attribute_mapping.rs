...
/// UpdateSamlConnectionRequestAttributeMapping : Define the atrtibute name mapping between Identity Provider and Clerk's user properties
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateSamlConnectionRequestAttributeMapping {
...
impl UpdateSamlConnectionRequestAttributeMapping {
    /// Define the atrtibute name mapping between Identity Provider and Clerk's user properties
    pub fn new() -> UpdateSamlConnectionRequestAttributeMapping {
