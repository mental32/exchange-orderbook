...
pub struct OrganizationDomains {
    #[serde(rename = "data")]
    pub data: Vec<models::OrganizationDomain>,
...
impl OrganizationDomains {
    pub fn new(data: Vec<models::OrganizationDomain>, total_count: i64) -> OrganizationDomains {
        OrganizationDomains { data, total_count }
    }
}
