...
pub struct CommercePlan {
    ...
    pub name: String,
    #[serde(rename = "fee")]
    pub fee: Box<models::CommerceMoneyResponse>,
    #[serde(rename = "annual_monthly_fee")]
    pub annual_monthly_fee: Box<models::CommerceMoneyResponse>,
    #[serde(rename = "annual_fee")]
    pub annual_fee: Box<models::CommerceMoneyResponse>,
    ...
    pub features: Vec<models::FeatureResponse>,
...
impl CommercePlan {
    pub fn new(
        ...
        id: String,
        name: String,
        fee: models::CommerceMoneyResponse,
        annual_monthly_fee: models::CommerceMoneyResponse,
        annual_fee: models::CommerceMoneyResponse,
        amount: i64,
        ...
        slug: String,
        avatar_url: String,
        features: Vec<models::FeatureResponse>,
    ) -> CommercePlan {
        CommercePlan {
            object,
            id,
            name,
            fee: Box::new(fee),
            annual_monthly_fee: Box::new(annual_monthly_fee),
            annual_fee: Box::new(annual_fee),
            amount,
            amount_formatted,
