...
pub struct BlocklistIdentifiers {
    #[serde(rename = "data")]
    pub data: Vec<models::BlocklistIdentifier>,
...
impl BlocklistIdentifiers {
    pub fn new(data: Vec<models::BlocklistIdentifier>, total_count: i64) -> BlocklistIdentifiers {
        BlocklistIdentifiers { data, total_count }
    }
}
