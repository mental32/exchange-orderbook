...
**creator_role_id** | Option<**String**> | Specify what the default organization role is for an organization creator. | [optional]
**domains_default_role_id** | Option<**String**> | Specify what the default organization role is for the organization domains. | [optional]
