...
**fee** | [**models::CommerceMoneyResponse**](CommerceMoneyResponse.md) |  | 
**annual_monthly_fee** | [**models::CommerceMoneyResponse**](CommerceMoneyResponse.md) |  | 
**annual_fee** | [**models::CommerceMoneyResponse**](CommerceMoneyResponse.md) |  | 
...
**features** | [**Vec<models::FeatureResponse>**](FeatureResponse.md) | The features included in this plan. | 
