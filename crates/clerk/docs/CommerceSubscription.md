...
**active_at** | Option<**i64**> | Unix timestamp (milliseconds) when the subscription became active. | [optional]
**past_due_at** | Option<**i64**> | Unix timestamp (milliseconds) when the subscription became past due. | [optional]
